...
public class CoffeeMakerTest {
	 ...
	 * 		the coffee costs
	 * 	Then we get the correct amount back
	 */
	@Test
	...
	/**
	 * Given a coffee maker with one valid recipe
	 * When we make coffee, selecting the valid recipe and paying exactly
	 * 		the coffee costs
	 * 	Then we get the correct amount back
	 */
	@Test
...
//		coffeeMaker.addInventory("3", "1", "1", "20");
	...
	public void testCheckInventory() throws InventoryException {
		...
		assertEquals(22, I.getMilk());
		assertEquals(15, I.getSugar());
		assertEquals(24, I.getChocolate());
	...
	public void testDeleteRecipe() {
		...
		// check if recipe1 was deleted
		boolean contains=false;
		for (Recipe r : coffeeMaker.getRecipes()) {
			// check if r is not null
			if (r != null) {
				if (r.getName().equals(recipe1.getName())) {
					contains=true;
					break;
				}
			}
